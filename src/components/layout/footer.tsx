      ...
      <div className="container py-12 px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold font-headline">KSTech Solutions</h3>
            <p className="text-sm text-primary-foreground/80">
              KING SERVICE TECH LTD (KST) solves electronics and IT service gaps in Eastern Province (Bugesera) and nationwide.
            </p>
            <p className="text-sm text-primary-foreground/80">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-semibold font-headline">Contact Info</h4>
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              <li>Address: V34R+P56, RN15, Nyamata, Bugesera</li>
              <li>Primary: <a href="tel:+250787649480" className="hover:text-accent transition-colors">+250 787 649 480</a></li>
              <li>Secondary: <a href="tel:+250798701852" className="hover:text-accent transition-colors">+250 798 701 852</a></li>
              <li>Email: <a href="mailto:kstrwanda@gmail.com" className="hover:text-accent transition-colors">kstrwanda@gmail.com</a></li>
            </ul>
          </div>
          <div className="space-y-4">
        ...
        <div className="mt-8 border-t border-primary-foreground/20 pt-6 text-center text-sm text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} KING SERVICE TECH LTD. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
