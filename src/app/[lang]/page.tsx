...
import { ArrowRight, Briefcase, Lightbulb, Users, Wrench } from "lucide-react";
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                From household appliance repair to complex industrial solutions,
                we provide expert technical services to solve your problems
                efficiently.
              </p>
            </div>
          </div>
          <div className="mx-auto grid grid-cols-1 gap-8 py-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {services.map((service) => (
              <Card
                key={service.id}
                className="flex flex-col overflow-hidden group hover:shadow-xl transition-shadow duration-300 bg-background"
              >
                <Link
        ...
        <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              We designed and deployed a state-of-the-art surveillance and
              networking solution, ensuring robust security and high-speed
              connectivity for a multi-tenant commercial building.
            </p>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="py-12 text-center">
            <p className="text-muted-foreground">
              Advertisement area is under construction.
            </p>
          </div>
        </div>
      </section>
